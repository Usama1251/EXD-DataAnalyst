...
print("Task8- Updated List with Notebook ", shopping_list)
...
print("Task9- Updated list without item that's not required", shopping_list)

#Task-10

print("Task10- Updated Shopping List with all applied methods ", shopping_list)
